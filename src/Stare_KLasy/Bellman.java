...
class Graphik{
    ...
    class Edge{
        int src , dest , weight;
        public Edge(){   // poczkowa kjonstrukcja krawedzi
            src = dest = weight  = 0;
        }
    ...
    public Graphik(int v , int e){
        ...
        edge = new Edge[e];
        for(int i = 0 ; i  < e  ; i++){
            edge[i] = new Edge ();   // dynamiczne przypisanie edgow do tablicy
        }
    }
}
...
public class Bellman{
    ...
    public void BellmanFord(Graphik graph , int src){
        ...
        // krok 1 zinicjalizuj dystansy od zrodla do wszystkich innych jako infinity
        ...
        /// 2 zwolnienie krawedzi sprawdzenie czy istnuje krotszwe poloczenie
        for(int i = 0 ; i < V ; i++){
            for(int j = 0 ;  j < E ; j++){
    ...
    public static void main(String[] args){
        ...
        bellman.BellmanFord ( graph , 0 );

        /// drugi print to sciezka
        }
    }
